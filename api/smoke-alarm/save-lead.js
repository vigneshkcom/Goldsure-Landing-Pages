...
async function sendInternalEmail(lead) {
  ...
  var html = [
    ...
    '<a href="https://smokealarms.goldsure.com.au/tracker" style="display:inline-block;padding:10px 14px;background:#111111;color:#ffffff;font-size:11px;font-weight:700;letter-spacing:0.04em;text-decoration:none;border-radius:6px;">Open Lead Tracker</a>',
    '</td></tr></table>',
