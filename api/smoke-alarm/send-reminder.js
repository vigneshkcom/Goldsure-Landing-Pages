...
function buildCustomerReminderHtml(lead) {
  ...
  return [
    ...
    '<p style="margin:0 0 12px;font-family:Arial,Helvetica,sans-serif;font-size:14px;color:#444444;line-height:1.7;">Your smoke alarm quote is awaiting approval and the details are set out below.</p>',
    '<p style="margin:0 0 18px;font-family:Arial,Helvetica,sans-serif;font-size:14px;color:#444444;line-height:1.7;">Please accept your quote before the deadline to secure current pricing and avoid delays in arranging your installation. Once accepted, our team will contact you to schedule the next available booking.</p>',
